...
:: Android packaging
set AND_CERT_NAME="cain2test"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\cain2test.p12
...
set IOS_DEV_CERT_PASS=0080
set IOS_PROVISION=cert\AirDemo.mobileprovision
...
set APP_ID=com.cain.test2

:: Output packages
set DIST_PATH=dist
set DIST_NAME=cain2test
